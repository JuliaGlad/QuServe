...
import com.example.myapplication.domain.usecase.restaurant.locations.DeleteLocationUseCase;
...
public class RestaurantLocationDI {
    ...
    public static DeleteLocationUseCase deleteLocationUseCase = new DeleteLocationUseCase();
