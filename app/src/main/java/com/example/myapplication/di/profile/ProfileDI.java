...
import com.example.myapplication.domain.usecase.profile.UpdateRestaurantVisitorUseCase;
...
public class ProfileDI {
    ...
    public static UpdateRestaurantVisitorUseCase updateRestaurantVisitorUseCase = new UpdateRestaurantVisitorUseCase();
