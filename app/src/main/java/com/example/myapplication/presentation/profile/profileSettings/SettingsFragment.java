...
//         initHelpButton();
    ...
    private void initBackButton() {
        binding.imageButtonBack2.setOnClickListener(v -> {
            NavHostFragment.findNavController(this)
                    .navigate(R.id.action_settingsFragment_to_profileLoggedFragment);
        });
    }
    ...
    private void initLogoutButton() {
        binding.constraintSettingsLogout.setOnClickListener(view -> {
            ...
            logout.setOnClickListener(viewLogout -> {
                ...
                NavHostFragment.findNavController(SettingsFragment.this).navigate(R.id.action_settingsFragment_to_navigation_profile);
    ...
    private void initChangeEmail() {
        binding.constraintChangeEmailPrivacy.setOnClickListener(view -> {showChangeEmailDialog();});
    }
