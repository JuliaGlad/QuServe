package com.example.myapplication.presentation.queue.createQueue.map;
...
public class MapViewModel extends ViewModel {
    ...
    private final MutableLiveData<String> _addressName = new MutableLiveData<>();
    LiveData<String> addressName = _addressName;
