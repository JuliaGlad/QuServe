...
public class RestaurantTableDetailsViewModel extends ViewModel {
    ...
    public void getTableData(String restaurantId, String locationId, String tableId) {
        RestaurantDI.getSingleTableByIdUseCase.invoke(restaurantId, locationId, tableId)
                .zipWith(RestaurantDI.getTableQrCodeJpgUseCase.invoke(tableId), TableDetailModel::new)
    ...
    public void getQrCodePdf(String tableId) {
        RestaurantDI.getTableQrCodePdfUseCase.invoke(tableId)
                .subscribeOn(Schedulers.io())
