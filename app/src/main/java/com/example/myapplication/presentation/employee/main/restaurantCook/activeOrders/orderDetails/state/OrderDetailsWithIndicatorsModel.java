...
public class OrderDetailsWithIndicatorsModel{
    ...
    public OrderDetailsWithIndicatorsModel(String dishId, String documentDishId, String amount, String name, String weight, String price, Task<Uri> task, List<String> topping, List<String> requiredChoice, List<String> toRemove) {
        this.dishId = dishId;
